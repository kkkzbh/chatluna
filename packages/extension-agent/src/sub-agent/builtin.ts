...
${
    ...
    'After making changes, run the build or tests to make sure things still work, ' +
    'then summarize what you changed and why.'
}

${
    "Always read a file before editing it — don't guess at contents. " +
    "Keep changes focused and don't refactor unrelated code. " +
